...
import 'package:main_grocery/pages/Installation_Page/widget/installing_page3.dart';
import 'package:main_grocery/pages/Login_Page/widget/signin.dart';

class InstallingPage2 extends StatelessWidget {
  @override
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    ...
                    child: Image(
                      image: AssetImage(
                          'assets/images/installation/installation_2.png'),
            ...
            FlatButton(
              onPressed: () {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => InstallingPage3(),
                  ),
                );
              },
              child: Row(
